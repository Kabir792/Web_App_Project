...
import { LayoutDashboard, CalendarCheck, ClipboardList, CheckCircle2, GraduationCap } from 'lucide-react';

export default function Sidebar({ activeTab, setActiveTab, onSwitchModule }) {
  return (
