...
export default function RegistrationPage({ user, onLogout, onSwitchModule }) {
  ...
  return (
    <div className="app-container">
      <Header user={user} onLogout={onLogout} onSwitchModule={onSwitchModule} />
        ...
        <div className="portal-metrics-grid">
          ...
          <div className="metric-card">
            ...
            <div className="metric-info">
              ...
              <span>{user.user_id} &bull; {user?.role === 'TEACHER' ? 'Teacher' : 'Admin'}</span>
            </div>
          </div>
